...
from model import Classifier, ClassifierNew
from torch.utils.data import DataLoader
from torchmetrics.classification import BinaryAUROC

# TODO: 

# Full data, no KL + simple CNN -> 86.46acc, 0.9363auroc, 86.19f1 (clf_simple_cnn_fulldata)
# Full data, no KL + Linear -> 64.69acc, 0.7059auroc, 59.64f1 (fulldata_linear)
# Full data, no KL + new CNN -> 89.40acc, 0.9672auroc, 89.61f1 (clf_new_fulldata)
# No virus, No KL + new CNN -> 93.24acc, 0.9783auroc, 93.37f1 (clf_new_nonvirus_resume)
# No virus, No KL + simple CNN -> 86.97acc, 0.9446auroc, 85.73f1 (clf_simple_cnn_reboot)
# No virus, No KL + Linear -> 70.79acc, 0.7716auroc, 69.46f1 (clf_linear_nonvirus)
# No virus, KL + simple CNN -> 89.81acc, 0.9570auroc, 90.36f1 (debug)
# No virus, KL + new CNN -> 92.90acc, 0.9825auroc, 94.53f1 (clf_kl_new_nonvirus)
...
parser.add_argument('--name', type=str, default='debug_new',
...
if args.load:
    ...
    classifier_model = ClassifierNew(args.seq_len, args.emsize)
